...
ggsave('r/figures/10_nc_family_ident.png', width=5, height=5, units='in')
...
ggsave('r/figures/10_nc_family_ident_1.png', width=5, height=5, units='in')
...
ggsave('r/figures/10_nc_family_ident_2.pdf', width=5, height=5, units='in')
