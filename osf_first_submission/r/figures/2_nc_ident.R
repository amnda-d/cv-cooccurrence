...
ggsave('r/figures/2_nc_ident.png', width=5, height=5, units='in')
...
ggsave('r/figures/2_nc_ident_1.png', width=5, height=5, units='in')
...
ggsave('r/figures/2_nc_ident_2.png', width=5, height=5, units='in')
...
ggsave('r/figures/2_nc_ident_3.png', width=5, height=5, units='in')
