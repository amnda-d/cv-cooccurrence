...
ggsave('r/figures/9_nc_family_sim.png', width=5, height=5, units='in')
...
ggsave('r/figures/9_nc_family_sim_1.png', width=5, height=5, units='in')
...
ggsave('r/figures/9_nc_family_sim_2.png', width=5, height=5, units='in')
